...
### v0.4.0-beta（2026-09-19）— 主题对比度两层模型 + DirectML 运行时内置 + 修图前后对比（预发布）
...
- **修图前后对比**（FEAT-068）：创意工坊图片处理新增 Lightroom 式视图——side 左右并排（Y/Y 快捷键）与 split 单画布分割对比（分割线可拖动）；「原图」语义跟随叠加链，无结果时入口禁用。
